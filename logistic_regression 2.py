## cara jalankan: python logistic_regression.py data.csv

# Import library untuk mendapatkan nama file dari input command line
import sys
...
# Dapatkan nama file dari input command line
filename = sys.argv[1]
